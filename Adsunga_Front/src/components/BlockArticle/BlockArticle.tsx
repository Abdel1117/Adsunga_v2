        ...
        >
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              <path
                style={{ fill: "#515262" }}
                d="M337.403,294.278c48.585,62.153,112.61,76.922,148.08,126.184 c35.47,49.263,6.901,71.922,6.901,71.922s-22.659,28.569-71.922-6.901s-64.031-99.496-126.184-148.08L337.403,294.278z"
              ></path>
              <path
                style={{ opacity: 0.1 }}
                d="M453.529,452.416c-49.262-35.47-64.031-99.496-126.184-148.08 l-33.066,33.066c62.153,48.585,76.922,112.611,126.184,148.08c49.263,35.47,71.922,6.901,71.922,6.901s9.117-7.234,10.655-22.411 C491.354,471.156,474.96,467.847,453.529,452.416z"
              ></path>
              <ellipse
                transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 297.5754 718.4259)"
                style={{ fill: "#B4BBCC;" }}
                cx="297.579"
                cy="297.583"
                rx="39.981"
              ...
              <path
                style={{ opacity: 0.1 }}
                d="M285.653,309.504c-12.263-12.263-12.553-32.845-2.289-50.941 c-4.944,2.805-9.703,6.391-14.056,10.744c-20.283,20.283-24.069,49.383-8.455,64.996c15.614,15.614,44.714,11.829,64.997-8.455 c4.352-4.352,7.939-9.112,10.744-14.056C318.498,322.058,297.917,321.767,285.653,309.504z"
              ></path>
              <circle
                style={{ fill: "#7DD2F0" }}
                cx="179.685"
